...
# Файлы конфигурации
CONFIG_FILE = "C:/efqm/K9/question_config.json"
INPUT_FILE = "C:/efqm/K9/input09_12_24.json"
PASSPORT_FILE = "C:/efqm/K9/example.txt"
department_name = "Пром.эл."  # Название кафедры
option_file = "C:/efqm/K9/option.txt"
ERROR_ID_FILE = "C:/efqm/K9/question_id_err.txt"  # Файл с ошибочными question_id
...
if __name__ == "__main__":
    ...
    # Чтение question_id из файла question_id_err.txt
    with open(ERROR_ID_FILE, "r", encoding="utf-8") as file:
        error_ids = file.readlines()
    error_ids = [line.strip() for line in error_ids]  # Убираем лишние пробелы и символы новой строки

    # Цикл до первого совпадения
    while current_index < len(questions):
        question = questions[current_index]
        if str(question["question_id"]) in error_ids:
    ...
    config["current_question_index"] = current_index + 1
    with open(CONFIG_FILE, "w") as file:
